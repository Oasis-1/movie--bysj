        ...
        function initBanner(){
            ...
            $.ajax({
                ...
                success:function (obj) {
                    ...
                    avatarShadow.append(
                        "<img class=\"avatar\" src=\"../static/images/cinemas/1.png\">" +
           ...
           // console.log(obj);
            ...
            for(var i=1;i<=5;i++){
                movieList.append(
                    ...
                    "<img src=\"../static/images/stills/"+obj.data[0].schedule_movie.movie_cn_name+"/"+i+".jpg\" alt=\""+obj.data[0].schedule_movie.movie_cn_name+"\">" +
                    "</div>"
                );
            }
