            ...
            $.ajax({
                ...
                success: function (obj) {
                    ...
                    for (var i = 0; i < obj.count; i++) {
                        movielist.append(
                            // "<li> <div class=\"movie-item\"> <a href=" + obj.data[i].movie_id + "\"buyTickets.jsp?movie_id=\" target=\"_blank\"> <div class=\"movie-poster\"> <img src=\"" + obj.data[i].movie_picture + "\"> </div> </a>" +
                    ...
                    if (obj.count > 0) {
                        for (var i = 0; i < obj.count; i++) {
                            movielist.append(
                                ...
                                "<div class=\"channel-action channel-action-sale\"> <a>购票<a/> </div> <div class=\"movie-ver\"></div> </div>" +
                                "<div class=\"channel-detail movie-item-title\" title=\"" + obj.data[i].movie_cn_name + "\">" +
                                //"<a href=" + obj.data[i].movie_id + "\"movieDetail.jsp?movie_id=\" target=\"_blank\">" + obj.data[i].movie_cn_name + "</a> </div>" +
                                "<a href=movieDetail.jsp?movie_id=" + obj.data[i].movie_id + "\" target=\"_blank\">" + obj.data[i].movie_cn_name + "</a> </div>" +
